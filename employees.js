...
//CODE HERE
const empOne = new Employee('Geoffrey', 'graveyard during the week')
/*
...
//CODE HERE
const manager = new Manager('porter', 'graveyard during the week', ['Geoffrey', 'Nick'])
